...
public class TestGraph {
    ...
    public static void main(String[] args) {
        ...
        test.testGraph.print();

        ArrayList<Vertex> vertices = new ArrayList<Vertex>();
        GraphTraverser.depthFirstTraversal(test.testGraph.getStartingVertex(), vertices);
        
        System.out.println("Printing Depth First traversed graph");
        for(Vertex v: vertices){
            System.out.println(v.getData());
        }

        ArrayList<Vertex> verticesBTS = GraphTraverser.breathFirstTraversal(test.testGraph.getStartingVertex());
        
        
        System.out.println("Printing Breath First traversed graph");
        for(Vertex v: verticesBTS){
            System.out.println(v.getData());
        }
    }
}
